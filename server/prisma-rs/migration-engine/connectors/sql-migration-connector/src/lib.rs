...
use url::Url;
use prisma_query::connector::{PostgresParams, MysqlParams, SqliteParams};
...
pub struct SqlMigrationConnector {
    ...
    pub database_inspector: Arc<dyn DatabaseInspector>,
}
        ...
        match PostgreSql::new(params) {
            ...
            Err(prisma_query::error::Error::QueryError(_)) => {
                let _ = {
                    ...
                    let connection = PostgreSql::new(PostgresParams::try_from(url)?)?;
